...
Then Move the cursor on the image
Then ​Click on second image from the image slider
Then Click on the third image from the image slider
Then Click on the first image from the image slider